...
$sql="select * from query where Department='Army'";
$result=mysql_query($sql,$conn) or die(mysql_error());
$rows=mysql_num_rows($result);
if($rows<=0){echo "No Queries In Army Department"."<br>".$_POST['name'];}
else{
...
echo "</tr>";}
echo "</table>"; }
$sql1="select * from query where Department='Navy'";
$result1=mysql_query($sql1,$conn) or die(mysql_error());
$rows1=mysql_num_rows($result1);
if($rows1<=0){echo "No Queries in Navy Department"."<br>";}
else{
  echo "<table border='1' width='100%' >
       <tr>
       <th width='2%'>Controlno</th>
...
echo "<td>".$row1['Description']."</td>";echo "<td>"."<form action='download.php' method='post'>
...
$sql2="select * from query where Department='Airforce'";
$result2=mysql_query($sql2,$conn) or die(mysql_error());
$rows2=mysql_num_rows($result2);
if($rows2<=0){echo "No Queries in Airforce Department"."<br>";}
else{
  echo "<table border='1' width='100%' >
       <tr>
       <th width='2%'>Controlno</th>
